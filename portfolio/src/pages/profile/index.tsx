...
function page() {
    return (
        <div className="flex h-full w-auto ">
            ...
            <div
                className="relative w-[72%] z-10 m-auto mt-[8rem] bg-[#ffffffd3] px-10 py-10 rounded-3xl "
                style={{
                ...
                <div className="grid grid-cols-2">
                    ...
                    <div>
                        ...
                        <div className="mb-10">
                            ...
                            <p className={`${styles.element} font-NanumNeo text-[1.4rem] mt-3 hover:font-bold hover:cursor-pointer`}>삼성 청년 SW 아카데미 8기 수료</p>
                        </div>
                        {/*  */}
                        <div className="mb-10">
                            ...
                            <div className="mt-3">
                                <div className="mb-3">
                                    <p className={`${styles.element} text-[1.4rem] font-NanumNeo hover:font-bold hover:cursor-pointer`}>IT조선 편집기자 인턴</p>
                                    <p className="text-[1rem] font-NanumNeo ">웹 디자인 및 웹 기획</p>
                                </div>
                                <p className={`${styles.element} text-[1.4rem] font-NanumNeo hover:font-bold hover:cursor-pointer`}>EBS 홍보부 계약직</p>
                        ...
                        <div className="mb-10">
                            ...
                            <p className={`${styles.element} mt-3 text-[1.4rem] font-NanumNeo hover:font-bold hover:cursor-pointer`}>삼성 청년 SW 아카데미 자율 프로젝트 우수상</p>
                        </div>
                    </div>
                    {/* right */}
                    <div>
